...
_NOTE: The prerequisite to securely install BU is_ [_COSIGN tool_](/testnet/cosign-setup) _that will guarantee the integrity of the files you want to download, you MUST install it before proceeding._
