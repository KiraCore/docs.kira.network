...
_NOTE: There is NO official support for any virtualization software in the KIRA stack. If you have to use virtualization we recommend_ [_VMWare_](https://www.vmware.com/) _for MacOS and_ [_WSL2_](/testnet/tools/wsl2-support) _for Windows._
