...
For a comprehensive overview of SEKAI's governance mechanism, including its structure, roles, and permissions, visit the [Governance](/learn/what-is-kira/backend---sekai/governance) page.
...
Unlike traditional PoS systems, block production in KIRA is separate from onchain governance. For more details on governance, visit the [Governance](/learn/what-is-kira/backend---sekai/governance) page.
...
The [MBPoS, Network Rewards and Incentives Structure](/learn/kira’s-economics/mbpos-network-rewards-and-incentives-structure) page discusses economic incentives for consensus nodes and their delegators.
