...
## Liquidity Bootstrapping Mechanism for Rollapps {#f158579a4606412e9fccf9f64d4a14d7}
...
KIRA’s stack combines several modular components to provide a ‘full-stack’ experience:
