...
1. **Virtual Finality Gadget** (VFG) - [VFG](/learn/bba461ae-7c67-4b66-8f1b-c51c887f2671) enables next-gen blockchain-less and resource-heavy applications to exist without the the coordination overhead associated with creation of new networks for every single new use case such as AI, streaming, or gaming.
