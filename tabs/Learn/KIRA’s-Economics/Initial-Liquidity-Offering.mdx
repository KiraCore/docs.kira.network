...
sidebar_position: 3
slug: /a6a660a6-3e5c-4a53-9ec3-14aa07f00351
---
...
6. A [Spending Pool](/docs/812fdf31-d225-4daf-a4cd-4501cbc00d95) is created for users who have bonded KEX. They are eligible to claim LP tokens from the Spending Pool, proportional to their respective bonded amounts. Depending on the dApp proposal, these LP tokens may be immediately claimable or progressively unlocked over time.
