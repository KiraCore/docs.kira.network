...
Set desired INTERX release version and binaries repo as env variables within `/etc/profile`, with [Bash-utils](/docs/tools/bash-utils) or manually. Sourcing `/etc/profile` is necessary.
