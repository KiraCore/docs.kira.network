...
## Installation {#6b4733753b1141ebadec8da43ee6c8fe}
...
The prerequisite to securely install BU is [COSIGN tool](/docs/backend---sekai/sekai-installation#95ea60da4e6647de9391afabd8b9c38f) that will guarantee the integrity of the files. It MUST be installed and KIRA’s public key added before proceeding.
...
### Using KIRA Manager {#a8c091760f38469a96d4b86ba746d162}


For a detailed KM setup walkthrough, visit the [Testnet](testnet/) section.
...
The prerequisite to install BU is [COSIGN tool](/docs/backend---sekai/sekai-installation#0069f1f3f89b4b34a56731be349776be) that will guarantee the integrity of the files and [Bash V5](/docs/backend---sekai/sekai-installation#e12ff19e5f33489d91417d9c4bd8f954) for better compatibility. They MUST be installed and KIRA’s public key added before proceeding.
...
### Alternative Installation Processes {#fd1fa8f22b214af586fab939156eefb5}


#### Using Binaries  {#44bd35a00e7d4292bb2cc44bf69f8959}


Unfortunately, it is not possible to install .deb packages on MacOS as of now.


#### Using KIRA Manager {#476faf3ef9b24b3e9e26762cb0f1047c}


For a detailed KM setup walkthrough, visit [testnet.kira.network](https://testnet.kira.network/).
