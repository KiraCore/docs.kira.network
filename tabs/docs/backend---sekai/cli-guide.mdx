...
`$NETWORK_NAME` and `$SEKAID_HOME` env variables should have been set up during [SEKAI installation](/docs/backend---sekai/sekai-installation) process and all other flags can be set as env variable. More on this in the section below.
