...
In KIRA, the only misbehavior that is handled is double signing. In this case the consensus node is automatically jailed upon detection but not automatically slashed. Instead, the slashing process is managed by governance through the slashing module. [Jailing & Slashing Procedures](/docs/d6fee8b3-1948-493e-bbdd-796bcc996c2b) provides all the necessary information regarding how this process works.
