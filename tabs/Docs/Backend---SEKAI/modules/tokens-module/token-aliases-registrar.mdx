...
sidebar_position: 2
slug: /e163e1d7-f16e-4c0d-945c-db2efc13ea49
---
...
## Concept  {#84215f46b44147a1ba6665006b16c6cb}
...
Removal of a token from the token aliases registry will automatically disable it by setting its [Token Rates Registrar](/docs/f19a45b3-88c4-469c-8642-772b941a1b24) properties `stake_token` and `fee_token` properties to `false`. 
