...
The prerequisite to securely install BU is [COSIGN tool](/docs/sekai-installation#95ea60da4e6647de9391afabd8b9c38f) that will guarantee the integrity of the files. It MUST be installed and KIRA’s public key added before proceeding.
...
The prerequisite to install BU is [COSIGN tool](/docs/sekai-installation#0069f1f3f89b4b34a56731be349776be) that will guarantee the integrity of the files and [Bash V5](/docs/sekai-installation#e12ff19e5f33489d91417d9c4bd8f954) for better compatibility. They MUST be installed and KIRA’s public key added before proceeding.
