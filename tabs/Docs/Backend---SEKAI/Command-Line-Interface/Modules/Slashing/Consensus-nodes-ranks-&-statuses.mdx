---
title: Consensus nodes ranks & statuses
sidebar_position: 3
...
## Concept {#f34eaf6c97424f8fbb0d31fc614016a3}
...
| `inactive_until`          | `google.protobuf.Timestamp` | `2023-05-09T00:00:00Z` | The timestamp consensus node cannot be activated until.                                                   |
...
Nodes rank and statuses are stored in the `x/staking` module and can be queried using [Consensus nodes & staking pools](/docs/4b7f76b2-83c1-4f7f-91cf-77f1105fbc6b) CLI. 
