...
The prerequisite to securely install BU is [COSIGN tool](/docs/cosign) that will guarantee the integrity of the files. It MUST be installed and KIRA’s public key added before proceeding.
