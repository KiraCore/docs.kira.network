...
sidebar_position: 4
slug: /775c220a-d41a-481c-9de9-febc1d08a17d
---
...
_The prerequisite to install bip39gen is Bash Utils (BU) tool, please refer to_ [_BU Setup page_](/testnet/085fa60c-91e1-448a-a11d-44b5221332e0) _before proceeding._
...
_WARNING!!! Before the hash function is applied all strings MUST be lowercase and all white spaces MUST be removed, in bash this can be ensured by using_ _`tr '[:upper:]' '[:lower:]' | tr -d '[:space:]'`_ _command._
